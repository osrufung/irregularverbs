...
#define imgTestscreenhelp4 (UIImage*)^{ UIImage *image = [UIImage imageNamed:@"testScreenHelp_4"]; ZAssert(image, @"Image testScreenHelp_4 not found"); return image; }()
...
#define imgTestscreenhelp3dot5 (UIImage*)^{ UIImage *image = [UIImage imageNamed:@"testScreenHelp_3dot5"]; ZAssert(image, @"Image testScreenHelp_3dot5 not found"); return image; }()
