...
#define imgDefault (UIImage*)^{ UIImage *image = [UIImage imageNamed:@"Default"]; ZAssert(image, @"Image Default not found"); return image; }()
...
#define imgDefault568h (UIImage*)^{ UIImage *image = [UIImage imageNamed:@"Default-568h"]; ZAssert(image, @"Image Default-568h not found"); return image; }()
