...
with open(path.join(path.expanduser('.'), args.destination), 'w') as file:
    file.write('// Created using the image.py script written by Patrick Hughes. He\'s a pretty cool guy.\n')
    file.write('//\n// DO NOT EDIT THIS FILE. \n//\n')
    file.write('// This file is automatically generated. Any changes will be overwritten the next time images.py is invoked.\n\n')
